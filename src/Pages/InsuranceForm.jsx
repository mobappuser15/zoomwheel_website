...
const InsuranceForm = ({
	...
	const totalItems = dataapi?.filter(
		(itemdata) => itemdata.leadType === "INSURANCE").length;
							...
							<table id='table-to-xls43'>
								...
								<tbody>
									...
									{dataapi.length === 0 ? (<>
										...
										<>
										{dataapi?.filter(
									(itemdata) => itemdata.leadType === "INSURANCE",).map((itemdata) => (
											<tr key={itemdata.leadUniqueSerial}>
												<td style={{ width: "" }}>
													{itemdata.leadUniqueSerial}
												</td>
												<td style={{ width: "" }}>{itemdata.vehOwnerName}</td>
												<td style={{ width: "" }}>{itemdata.vehBrandCode}</td>

												<td style={{ width: "" }}>
													{itemdata.vehModelCode}
												</td>
												<td style={{ width: "" }}>{itemdata.vehOwnerEmail}</td>
